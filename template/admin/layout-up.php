...
<body class="font-fira overflow-x-hidden">
    <div class="app-container relative min-h-screen flex">
        <header class="flex fixed top-0 left-0 right-0 w-full">
            <aside
                ...
                <div class="nav-side w-full mt-3">
                    ...
                    <div class="nav-menu p-3 rounded mb-3 hover:bg-primary hover:text-white">
                        <a href="../admin/product.php"><i class="fas fa-database"></i> Data Produk</a>
                    </div>
                    <div class="nav-menu p-3 rounded mb-3 hover:bg-primary hover:text-white">
                        <a href="../admin/aktivitas.php"><i class="fa-solid fa-clock-rotate-left"></i> Aktivitas</a>
                    </div>
                    <div class="nav-menu p-3 rounded mb-3 hover:bg-primary hover:text-white">
                        <a href="../admin/testimoni.php"><i class="fas fa-people-arrows"></i> Testimoni</a>
                    </div>
                    <div class="nav-menu p-3 rounded mb-3 hover:bg-primary hover:text-white">
            ...
            <nav class="w-full h-[85px] border-b-[2px] border-b-gray-200 z-[100]">
