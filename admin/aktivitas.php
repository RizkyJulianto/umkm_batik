...
<section class="activity w-full ml-[300px] pt-[85px] bg-[#f5f5f5] min-h-screen overflow-y-auto">
    <div class="header-admin w-full bg-white py-5 px-7">
        <div class="flex flex-col">
            <h3 class="text-xl"><i class="fas fa-clock-rotate-left"></i> Aktivitas</h3>
    ...
    <main class="row-activity py-5 px-7">
